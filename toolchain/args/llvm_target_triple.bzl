LLVM_TARGET_TRIPLE = select({
    ...
    "@toolchains_llvm_bootstrapped//platforms/config:linux_x86_64_gnu": ["x86_64-linux-gnu"],
    ...
    "@toolchains_llvm_bootstrapped//platforms/config:cosmo_x86_64": ["x86_64-unknown-unknown"],
    "@toolchains_llvm_bootstrapped//platforms/config:cosmo_aarch64": ["aarch64-unknown-unknown"],
...
# HAX!!!
# Same as above but swap the triple for cosmo to linux to prevent g++ invocation
LLVM_LINK_TARGET_TRIPLE = select({
    #TODO: Generate this automatically
    "@toolchains_llvm_bootstrapped//platforms/config:linux_x86_64_gnu": ["x86_64-linux-gnu"],
    "@toolchains_llvm_bootstrapped//platforms/config:linux_aarch64_gnu": ["aarch64-linux-gnu"],
    "@toolchains_llvm_bootstrapped//platforms/config:linux_x86_64_musl": ["x86_64-linux-musl"],
