...
def _cosmo_extension_impl(mctx):
    ...
    cosmo_repository(
        ...
        patches = [
            ...
            "//runtimes/cosmo/patches:0051-tls-alignment-guard.patch",
            "//runtimes/cosmo/patches:0052-ape-aarch64-avoid-x86-pop.patch",
            "//runtimes/cosmo/patches:0053-aarch64-stackchkguard.patch",
            "//runtimes/cosmo/patches:0054-aarch64-lds-lower-base.patch",
            "//runtimes/cosmo/patches:0055-aarch64-lds-restore-end.patch",
